<x-app-layout>
    <div class="container p-8">
        <div class="contenedor-fondo">
            <div class="row">
                <div class="col-sm-12">
                <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / <a href="" class="migas_pan">Atención de emergencia</a>
                </div>
            </div>
        ...
        @foreach ($seconds as $second)
            @if ($second->category_id = 1 && $second->maincontent_id = 4)
                @php
                    $mostrar = false;
...
<style>
    main
    {
        background: url('{{ Storage::url('home/background1.png') }}');
