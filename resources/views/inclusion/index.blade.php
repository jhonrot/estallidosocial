...
<x-app-layout>
    <div class="container p-8">
        <div class="contenedor-fondo">
            <div class="row">
                <div class="col-sm-12">
                <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / <a href="" class="migas_pan">Inclusión y reconciliación</a>
                </div>
            </div>
...
<style>
    main
    {
        background: url('{{ Storage::url('home/background2.png') }}');
