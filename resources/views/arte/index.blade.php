<x-app-layout>
    <div class="container p-8">
        <div class="contenedor-fondo">
            <div class="row">
                <div class="col-sm-12">
                    <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / <a href="" class="migas_pan">Arte y cultura</a>
                </div>
            </div>

        @foreach ($maincontents as $maincont)
            <h1 class="mb-12 title-color-green">
                @if ($maincont->id == '6')
                    {{ $maincont->title }}
                @endif
            </h1>
...
<style>
    main
    {
        background: url('{{ Storage::url('home/BACKGROUND7.png') }}');
