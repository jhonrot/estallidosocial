...
<x-app-layout>
    <div class="container p-8">
        <div class="row">
            <div class="col-sm-12">
                <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / Movilización social / <a href="" class="migas_pan">Territorio y representaciones colectivas</a>
            </div>
        </div>

        <h1 class="mb-12 title-color-green">Territorio y representaciones colectivas</h1>

        <div class="row">
            <div class="col-sm-12">
                <p>Las expresiones que emergen durante las movilizaciones del 2021 y posterior a ellas, generan cambios territoriales sobre las maneras de representarnos la vida en común.</p>
            </div>
        </div><br><br>
