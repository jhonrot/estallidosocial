...
<x-app-layout>
    <div class="container p-8">
        <div class="contenedor-fondo">
            <div class="row">
                <div class="col-sm-12">
                    <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / <a href="" class="migas_pan">Antecedentes y contexto</a>
                </div>
            </div>

        @foreach ($maincontents as $maincont)
            @if ($maincont->id == '1')
                <h1 class="mb-12 title-color-green">{{ $maincont->title }}</h1>
            @endif
        @endforeach
                ...
                <div class="col-sm-12">
                    <form action="" id="form-filtro-palabra">
                        <div class="form-group col-sm-6 element-form" id="filtro-contenedor-tipo" style="display: none">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control out-border-radius-left" name="filtro-tipo" id="filtro-tipo" onchange="filtro_cambiar_tipo(this.value)" style="display: none">
                                    <option value="" disabled>Seleccione el filtro</option>
                                    <option value="3">Palabra clave</option>
                                    <option value="0">Todos</option>
                                </select>

                                <span class="input-group-btn" id="filtro-contenedor-boton">
                                    <button type="button" class="btn btn-primary out-border-radius-left" title="Buscar" onclick="filtro_paginacion('0')">
                        ...
                        <div class="form-group col-sm-6 element-form" id="filtro-contenedor-palabra">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control out-border-radius-rigth" name="filtro-palabra" id="filtro-palabra" minlength="" maxlength="50" value="{{ $palabra }}">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-primary out-border-radius-left" title="Buscar" onclick="filtro_paginacion('3')" onkeypress="filtro_palabra_buscar()">
                                        <i class="fas fa-search"></i>
                                    </button>
                                </span>
                            </div>                        
...
<style>
    main
    {
        background: url('{{ Storage::url('home/background4.png') }}');
