...
<x-app-layout>
    <div class="container p-8">
        <div class="row">
            <div class="col-sm-12">
                <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / Movilización social / <a href="" class="migas_pan">Análisis y reflexiones</a>
            </div>
        </div>

        <h1 class="mb-12 title-color-green">Análisis y reflexiones</h1>

        <div class="row">
            <div class="col-sm-12">
                <p>Existen múltiples reflexiones y análisis sobre la movilización social del 2021, los impactos, los legados, los retos que quedan para la sociedad caleña.</p>
            </div>
        </div><br><br>
