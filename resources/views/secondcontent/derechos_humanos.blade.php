...
<x-app-layout>
    <div class="container p-8">
        <div class="row">
            <div class="col-sm-12">
            <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / Movilización social / <a href="" class="migas_pan">Derechos humanos en en contexto de la movilización social</a>
            </div>
        </div>

        <h1 class="mb-12 title-color-green">Derechos humanos en en contexto de la movilización social</h1>

        <div class="row">
            <div class="col-sm-12">
                <p>Las movilizaciones del 2021 arribaron con iniciativas inéditas para cuidar la vida y ejercer el derecho a la protesta.</p>
            </div>
        </div><br><br>
