...
<x-app-layout>
    <div class="container p-8">
        <div class="contenedor-fondo">
            <div class="row">
                <div class="col-sm-12">
                    <a href="{{Route('secondcontent.home')}}" class="migas_pan">Inicio</a> / Movilización social / <a href="" class="migas_pan">Una mirada Panorámica</a>
                </div>
            </div>
            <h1 class="title-color-green">Una mirada Panorámica</h1>
            <div class="row">
                <div class="col-sm-12">
                    <p>A partir del 28 de abril de 2021 se generaron una serie de manifestaciones que contaron con una participación multitudinaria e inédita, a partir de las cuales se gestaron diversidad de expresiones comunitarias, formas de movilización y de relacionamiento ciudadano.</p>
                </div>
            </div><br><br>
                        ...
                        <div class="form-group col-sm-6 element-form" id="filtro-contenedor-tipo" style="display: none">
                            ...
                            <div class="input-group">
                                <select name="filtro-paginacion" id="filtro-paginacion" class="form-control out-border-radius-rigth">
                                    <option value="5">5 articulos por pagina</option>
                                    <option value="10">10 articulos por pagina</option>
                                    <option value="20">20 articulos por pagina</option>
                                    <option value="50">50 articulos por pagina</option>
                                    <option value="100">100 articulos por pagina</option>
                                </select>
        ...
        @if(true)
            ...
            <h2 class="text-2xl text-gray-700 font-ral font-semibold mb-6 contenedor-fondo" id="titulo-musica">Música Videoclips</h2>
...
<style>
    main
    {
        background: url('{{ Storage::url('home/BACKGROUND5.png') }}');
